...
function abrirModalMostrar() {
  ...
  document.getElementById("mostrarTipoID").textContent    = c[1].textContent;
  document.getElementById("mostrarID").textContent        = c[2].textContent;
  document.getElementById("mostrarNombre").textContent    = c[3].textContent;
  document.getElementById("mostrarApellido").textContent  = c[4].textContent;
  document.getElementById("mostrarSexo").textContent      = c[5].textContent;
  document.getElementById("mostrarDireccion").textContent = c[6].textContent;
  document.getElementById("mostrarTelefono").textContent  = c[7].textContent;
  document.getElementById("mostrarCorreo").textContent    = c[8].textContent;
...
function abrirModalModificar() {
  ...
  document.getElementById("inputTipoID").value    = celdas[1].textContent;
  document.getElementById("inputID").value        = celdas[2].textContent;
  document.getElementById("inputNombre").value    = celdas[3].textContent;
  document.getElementById("inputApellido").value  = celdas[4].textContent;
  document.getElementById("inputSexo").value      = celdas[5].textContent;
  document.getElementById("inputDireccion").value = celdas[6].textContent;
  document.getElementById("inputTelefono").value  = celdas[7].textContent;
  document.getElementById("inputCorreo").value    = celdas[8].textContent;
